...
Solution: [Apptication](seminar03/Application.java)  
[Person class and comparators](seminar03/Person.java)
...
Solution [ Руководитель и имплементация](seminar03/Director.java)
